...
/**
 * Read-only registration status for a vendor portal.
 *
 * Deliberately inert: it reports where the vendor's registration has got to and
 * offers no action. Progressing an onboarding — approving, holding, sending back —
 * is an ADMIN responsibility, and surfacing those controls in the vendor portal is
 * what made the two roles blur together.
 *
...
export default function RegistrationStatusCard({ steps = [], title = 'Registration Status', note }) {
