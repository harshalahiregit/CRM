const STATUS_MAP = {
  ...
  Viewed:               { bg: 'rgba(59,130,246,0.1)',  color: '#3b82f6' },
  Opened:               { bg: 'rgba(59,130,246,0.1)',  color: '#3b82f6' },
  'Under Negotiation':  { bg: 'rgba(236,72,153,0.1)',  color: '#ec4899' },
  'Revision Requested': { bg: 'rgba(168,85,247,0.1)',  color: '#c084fc' },
