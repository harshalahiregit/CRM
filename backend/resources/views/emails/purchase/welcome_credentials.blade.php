{{-- Purchase welcome + credentials, sent when the vendor is added (before
     activation) so they can log in and complete onboarding. --}}
<!DOCTYPE html>
<html>
...
<tr><td align="center">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.08);">
    ...
    <tr><td style="background:linear-gradient(135deg,#6d28d9,#7c3aed);padding:28px 32px;">
      ...
      @endif
      <div style="color:rgba(255,255,255,.9);font-size:13px;margin-top:6px;">Procurement Vendor Portal</div>
    </td></tr>
    ...
    <tr><td style="padding:32px;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:4px 0;margin:0 0 18px;">
        ...
        <tr>
          <td style="padding:9px 16px;font-size:12px;color:#6b7280;">Vendor Code</td>
          <td style="padding:9px 16px;font-size:13px;color:#111827;font-weight:600;">{{ $vendor->purchase_vendor_code }}</td>
        </tr>
      </table>
      ...
      <p style="font-size:12px;color:#7c3aed;word-break:break-all;margin:0 0 26px;">{{ $portalUrl }}</p>
