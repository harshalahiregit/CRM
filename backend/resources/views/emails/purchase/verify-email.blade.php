{{-- Purchase Vendor verify-email e-mail. Table-based + inline CSS so it renders in
...
<tr><td align="center">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,.08);">
    ...
    <tr><td style="padding:32px;">
      <div style="font-size:22px;font-weight:800;color:#111827;margin:0 0 4px;">Confirm your email address</div>
      <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 22px;">
        Hello <strong>{{ $vendor->company_name }}</strong>, thanks for registering. Confirm this address to activate your portal sign-in.
      </p>

      <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 22px;">
        <tr><td style="border-radius:9px;background:#7C3AED;">
          <a href="{{ $actionUrl }}" style="display:inline-block;padding:13px 26px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;">Confirm email address</a>
        </td></tr>
      </table>
      ...
      <p style="font-size:12.5px;color:#6b7280;line-height:1.6;margin:0;">If you did not create this account, you can safely ignore this email &mdash; nothing will happen until the address is confirmed.</p>
    </td></tr>
