                ...
                <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 6px 24px rgba(15,23,42,0.08);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 18px; font-size:14px; color:#334155; line-height:1.7;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 20px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:18px 20px; text-align:center;">
                                        <span style="display:inline-block; padding:5px 12px; border-radius:999px; background:#e2e8f0; color:#475569; font-size:13px; font-weight:bold; text-transform:capitalize;">{{ str_replace('-', ' ', $oldStatus) }}</span>
                                        <span style="margin:0 10px; color:#94a3b8; font-size:16px;">&rarr;</span>
                                        <span style="display:inline-block; padding:5px 12px; border-radius:999px; background:#cffafe; color:#0e7490; font-size:13px; font-weight:bold; text-transform:capitalize;">{{ str_replace('-', ' ', $newStatus) }}</span>
                                    </td>
                                </tr>
                            </table>
