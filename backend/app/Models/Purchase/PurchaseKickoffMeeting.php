...
/**
 * A Purchase-vendor kickoff meeting. Purchase-owned (purchase_kickoff_meetings) —
 * completely independent of the shared/TPV kickoff engine. Not polymorphic: a
 * Purchase kickoff always belongs to a Purchase vendor (purchase_vendor_id →
 * purchase_vendors). Fully Purchase-owned.
 */
class PurchaseKickoffMeeting extends Model
{
    ...
    protected $appends = ['status_label', 'is_acknowledged'];
