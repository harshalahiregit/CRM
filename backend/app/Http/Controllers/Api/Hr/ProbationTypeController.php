...
use App\Services\Hr\ProbationTypeService;
use Illuminate\Http\Request;

/**
 * Probation Management → Probation Types (Phase 1). Thin: validate, delegate,
...
{
    public function __construct(private ProbationTypeService $service)
    {
    }
    ...
    private function validated(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            'default_duration_days' => 'nullable|integer|min:0|max:1000',
            'confirmation_required' => 'boolean',
            'review_required'       => 'boolean',
            'extension_allowed'     => 'boolean',
            'max_extensions'        => 'nullable|integer|min:0|max:20',
