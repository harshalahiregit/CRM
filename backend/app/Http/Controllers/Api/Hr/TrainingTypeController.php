...
use App\Services\Hr\TrainingTypeService;
use Illuminate\Http\Request;

/**
 * Learning & Development → Training Types (Phase 1). Thin: validate, delegate,
 * return JSON. Reads open to HR users; writes require HR-queue management.
 * Tenant-scoped, audited.
 */
class TrainingTypeController extends Controller
{
    public function __construct(private TrainingTypeService $service)
    {
    }
    ...
    private function validated(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            'default_duration_hours'   => 'nullable|integer|min:0|max:2000',
