...
use App\Services\Hr\ExitTypeService;
use Illuminate\Http\Request;

/**
 * Exit Management → Exit Types (Phase 1). Thin: validate, delegate, return JSON.
...
{
    public function __construct(private ExitTypeService $service)
    {
    }
    ...
    private function validated(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            'default_notice_days'     => 'nullable|integer|min:0|max:365',
