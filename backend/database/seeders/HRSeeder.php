...
class HRSeeder extends Seeder
{
    ...
    {
        // NOTE: candidates are seeded WITHOUT an ai_score. The literals that used
        // to live here (87, 91, 74, 95 ...) bypassed every formula and were the
        // reason stored scores matched no calculation. Scores now come only from
        // CandidateScoringEngine, via `php artisan hr:ai-score`.
        // ── Job Postings ────────────────────────────────────────────────
        $jobs = [
        ...
        // ── Candidates ──────────────────────────────────────────────────
        $candidates = [
            ['name'=>'Arjun Sharma','email'=>'arjun.sharma@gmail.com','phone'=>'+91 98765 43210','location'=>'Bangalore','current_company'=>'TechCorp India','experience_years'=>5.0,'source'=>'LinkedIn','stage'=>'Interview','job_posting_id'=>1,'skills'=>['React.js','TypeScript','Node.js','GraphQL','AWS'],'linkedin_url'=>'https://linkedin.com/in/arjun-sharma-dev'],
            ['name'=>'Divya Nair','email'=>'divya.nair@gmail.com','phone'=>'+91 98765 11111','location'=>'Mumbai','current_company'=>'SalesForce India','experience_years'=>3.5,'source'=>'Naukri','stage'=>'Offer','job_posting_id'=>2,'skills'=>['B2B Sales','CRM','Negotiation','Salesforce'],'linkedin_url'=>null],
            ['name'=>'Rohan Verma','email'=>'rohan.verma@gmail.com','phone'=>'+91 98765 22222','location'=>'Pune','current_company'=>'Deloitte','experience_years'=>4.0,'source'=>'Career Page','stage'=>'Screening','job_posting_id'=>5,'skills'=>['Financial Analysis','Excel','SAP','Python'],'linkedin_url'=>null],
            ['name'=>'Priya Mehta','email'=>'priya.mehta@gmail.com','phone'=>'+91 98765 33333','location'=>'Delhi','current_company'=>'Wipro HR','experience_years'=>5.5,'source'=>'Employee Referral','stage'=>'Assessment','job_posting_id'=>3,'skills'=>['HRIS','Recruiting','Labor Law','Performance Management'],'linkedin_url'=>null],
            ['name'=>'Karan Singh','email'=>'karan.singh@gmail.com','phone'=>'+91 98765 44444','location'=>'Bangalore','current_company'=>'Infosys Cloud','experience_years'=>4.5,'source'=>'LinkedIn','stage'=>'Hired','job_posting_id'=>6,'skills'=>['Docker','Kubernetes','AWS','Terraform','CI/CD'],'linkedin_url'=>'https://linkedin.com/in/karan-singh-devops'],
            ['name'=>'Anjali Gupta','email'=>'anjali.gupta@gmail.com','phone'=>'+91 98765 55555','location'=>'Bangalore','current_company'=>'Freshworks','experience_years'=>2.0,'source'=>'Internal Portal','stage'=>'Applied','job_posting_id'=>4,'skills'=>['Product Management','Agile','JIRA','User Research'],'linkedin_url'=>null],
            ['name'=>'Vikram Patel','email'=>'vikram.patel@gmail.com','phone'=>'+91 98765 66666','location'=>'Hyderabad','current_company'=>'Capgemini','experience_years'=>6.0,'source'=>'LinkedIn','stage'=>'Applied','job_posting_id'=>1,'skills'=>['React.js','Angular','Vue.js','REST APIs'],'linkedin_url'=>'https://linkedin.com/in/vikram-patel-fe'],
            ['name'=>'Sneha Iyer','email'=>'sneha.iyer@gmail.com','phone'=>'+91 98765 77777','location'=>'Chennai','current_company'=>'HCL','experience_years'=>2.5,'source'=>'Naukri','stage'=>'Screening','job_posting_id'=>2,'skills'=>['Sales','Lead Generation','Cold Calling','Salesforce'],'linkedin_url'=>null],
            ['name'=>'Pooja Sharma','email'=>'pooja.sharma@gmail.com','phone'=>'+91 98765 88888','location'=>'Gurgaon','current_company'=>'Accenture HR','experience_years'=>5.0,'source'=>'LinkedIn','stage'=>'Interview','job_posting_id'=>3,'skills'=>['HR Strategy','Talent Acquisition','HRBP','Succession Planning'],'linkedin_url'=>null],
            ['name'=>'Rahul Joshi','email'=>'rahul.joshi@gmail.com','phone'=>'+91 98765 99999','location'=>'Pune','current_company'=>'Persistent Systems','experience_years'=>4.0,'source'=>'LinkedIn','stage'=>'Interview','job_posting_id'=>1,'skills'=>['React.js','Redux','Node.js','MongoDB'],'linkedin_url'=>'https://linkedin.com/in/rahul-joshi-react'],
            ['name'=>'Meena Reddy','email'=>'meena.reddy@gmail.com','phone'=>'+91 98765 10101','location'=>'Hyderabad','current_company'=>'Freshdesk','experience_years'=>3.0,'source'=>'Walk-in','stage'=>'Assessment','job_posting_id'=>3,'skills'=>['HR Operations','Payroll','Compliance','HRIS'],'linkedin_url'=>null],
            ['name'=>'Sunita Rao','email'=>'sunita.rao@gmail.com','phone'=>'+91 98765 20202','location'=>'Bangalore','current_company'=>'Oracle India','experience_years'=>7.0,'source'=>'Internal Portal','stage'=>'Hired','job_posting_id'=>4,'skills'=>['Product Strategy','OKRs','Analytics','Roadmapping'],'linkedin_url'=>null],
        ];
